...
| `core-loaders-hardening` | ローダー堅牢性・対応形式拡張 — **第1弾（TS 堅牢化: LD-03/04/05/06/08/09・PR #39）＋第3弾（LD-07/10/12/13 解消・LD-11 仕様判断）実装済み（PR #43）。残りは第2弾（LD-01/02・開く経路）のみ** | 13 | 🔴高 | LD-01 CSV 開けず・LD-02 .mf4 限定（残り第2弾） |
